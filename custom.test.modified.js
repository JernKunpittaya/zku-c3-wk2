...
describe("Custom Tests", function () {
  ...
  it("[assignment] ii. deposit 0.1 ETH in L1 -> withdraw 0.08 ETH in L2 -> assert balances: recipient, omniBridge, tornadoPool", async () => {
    ...
    // Alice withdraws her 0.08 from the shielded pool
